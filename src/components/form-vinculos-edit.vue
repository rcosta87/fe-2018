        ...
        <nav-inneredit></nav-inneredit>
         ...
         <form class="row" id="vinculos">
            <div class="col-xs-12 col-md-3">
               ...
               <input type="text" name="indetificador" value="12563989-96">
            </div>
            <div class="col-xs-12 col-md-3">
            ...
            <div class="col-xs-12 col-md-3">
               ...
               <input type="date" name="data_inicial" value="2018-06-08">
            </div>
            <div class="col-xs-12 col-md-3">
               <label for="data_final">Data Final</label>
               <input type="date" name="data-final" value="2018-07-30">
            </div>
         </form>
         <div class="space"></div>
      </div>
      <send-btn rota="/"></send-btn>
   </formulario-wrap>
