        ...
        <h1 class="title-content">Identificadores</h1>
         ...
         <form class="row" id="indenficadores">
            ...
            <div class="col-xs-12 col-md-6">
               ...
               <input type="text"
                  id="designacao"
                  name="designacao" v-model="designacao">
            </div>
            <div class="col-xs-12 col-md-6">
               <label for="data">Data</label>
               <input type="date"
                  id="data"
                  name="data" value="2013-01-08">
            </div>
            <div class="col-xs-12 col-md-6">
               <label for="emissor">Emissor</label>
               <input type="text"
                  id="emissor"
                  name="emissor" size="25" value="Hospital Municipal de Saúde">
            </div>
            <div class="form-group  row">
               ...
               <div class="col-xs-12">
                  ...
                  <input type="text"
                     id="cartorio"
                     name="cartorio" size="25" value="Cartório do Quinto Ofício de Notas">
               </div>
               <div class="col-xs-12 col-md-4">
                  <label for="livro">Livro</label>
                  <input type="number" class="input" name="livro" value="25">
               </div>
               <div class="col-xs-12 col-md-4">
                  <label for="folha">Folha</label>
                  <input type="number" class="input" name="folha" value="15">
               </div>
               <div class="col-xs-12 col-md-4">
                  <label for="termo">Termo</label>
                  <input type="number" class="input" name="termo" value="89">
               </div>
            </div>
            <div class="form-group row">
               <div class="col-xs-12">
                  <h2><strong>Carteira de Trabalho</strong></h2>
                  <p>&nbsp;</p>
               </div>
               <div class="col-xs-12 col-md-6">
                  <label for="serie">Série</label>
                  <input type="number" name="serie" value="2555">
               </div>
               <div class="col-xs-12 col-md-6">
                  ...
                  <select
                     id="estado"
                     name="estado">
                     <option v-for="item in estados" v-bind:value="item.sigla" v-bind:key="item.sliga">{{item.nome}}</option>
                  </select>
               </div>
            </div>
            <div class="form-group row">
               <div class="col-xs-12">
                  <h2><strong>Título de Eleitor</strong></h2>
                  <p>&nbsp;</p>
               </div>
               <div class="col-xs-12 col-md-6">
                  <label for="zona">Zona</label>
                  <input type="number" name="zona" value="133">
               </div>
               <div class="col-xs-12 col-md-6">
                  <label for="sessao">Sessão</label>
                  <input type="number" name="sessao" value="255">
               </div>
            </div>
            <div class="space"></div>
         </form>
